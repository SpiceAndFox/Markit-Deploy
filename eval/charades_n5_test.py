...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_path", type=str, required=True, help="Charades-style test annotation JSON.")
    ...
    '''
    1. The red numbers on each frame represent the frame number.
    2. The red numbers on each frame indicate the frame number.
